...
@section("contenu")
<link rel="stylesheet" href="{{ asset('css/Outil de mesure/Ajout_Un_Outil_De_Mesure.css')}}">
<script src="https://code.jquery.com/jquery-3.6.0.js" ></script>
{{-- ajout d'un outil de mesure --}}
<div class="container" id="addoutilmes">
<form action="{{route('AjoutUnOutilDeMesure.Ajouter')}}" method="post">
      @csrf
        <div class="ajout">
            @include('sweetalert::alert')
            <h2 class="mb-5 addoutilmestitle">Ajouter<b> Un Outil De Mesure</b></h2>
            <div class="info_sur_outil ">
                <div class="col mb-4">
                    ...
                    <div class="champ">
                        <input type="text" name="DesOutilMesure" id="id"> 
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="titre mt-2">
                ...
                <div class="col mb-4">
                    ...
                    <div class="champ">
                        <input type="text" name="NumFicheAchat" class="place1">
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="titre mt-2">
