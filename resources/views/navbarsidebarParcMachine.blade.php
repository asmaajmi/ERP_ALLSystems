            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    ...
                    <li  class="nav-item {{'ParcMachine/Machine' == request()->path() ? 'active' : ''}}">
                        <a class="nav-link active" href="{{route('machine.list')}}">Parc Machine</a>
                    </li>
        ...
        <div class="offcanvas-body px-2">
            <nav class="navbar-dark">
                <ul class="navbar-dark-ul mt-2">
                    ...
                    <li class="{{'ParcMachine/machine' == request()->path() ? 'active' : ''}}">
                            <a href="{{route('machine.list')}}" class="nav-link px-0">
                                <span class="me-2">
                                <i class="bi bi-gear-fill sideicon"></i>
                                </span>                      
                                <span class="txtsidebar">Gestion des machines</span>                                
                            </a>
                    </li> 
