...
<div class="tablesformheureaeff">
	<form action="{{route('congenonplanifie.create')}}" method="post">
		@csrf
		<div class="ajoutcongeplan">
			@include('sweetalert::alert')
			<h2 class="titrecongeplanifie">Ajouter <span id="emp">un congé non planifié</span></h2>
			<table class="formcongeplanifie">
				...
				<tr>
					<td class="txtcongeplanifie">
						<h3 class="formtxt" id="datedebutconge">Date debut</h3>
					</td>
					<td>
						<div class="champscongeplanifie">
				...
				<tr class="paydes">
					<td class="txtcongeplanifie">
						<h3 class="formtxt" id="desconge">Type congé</h3>
					</td>
					<td>
						<div class="champscongeplanifie" >
