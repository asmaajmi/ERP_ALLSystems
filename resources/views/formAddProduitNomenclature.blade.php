...
<div class="tablesformnomenclature">
	<form action="{{route('ComposantNomenclature.create',['nomenclature'=> $nomenclature->id])}}" method="post">
		@csrf
		<div class="ajout_nomen">
			@include('sweetalert::alert')
			<h2 class="titrenomenclature">Ajouter<span id="emp"> des autres composants pour {{$nomenclature->designation}}</span></h2>
			<h3 class="ajout_prod_const">Ajouter les sous_produits construisable</h3>
