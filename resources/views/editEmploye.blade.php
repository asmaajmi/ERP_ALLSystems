...
<div class="tables">
            ...
            <input type="hidden" name="_method" value="put">
                <div class="ajoutemp">
                   <h2>Modifier <span id="emp">Un Employé</span></h2>
                    ...
                    <table id="table2">
                        ...
                        <td>
                                ...
                                <td>           
                                    <div id="champ">
                                    <label id="dir"><input type="radio" name="role" value="directeur" disabled>&nbsp Directeur</label>
                                    <label id="empl"><input  type="radio" name="role" value="employe" checked >&nbsp Employé</label>
                                    </div>
                        ...
                        <td>
                             ...
                             <select name="id_serv">
                                ...
                                <td>
                                    <h3 class="line2">Date Debut</h3>
                                </td>
                                <td>
                                    <div class="champ">
                                        <input type="date" name="date_debut_tr" id="dates" value="{{$travail->date_debut_tr}}">
                                    </div>
                                </td>
                        </tr>
                    </table>
